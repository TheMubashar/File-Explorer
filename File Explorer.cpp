 ...
 * #File Explorer with Stack Implementation
 *
 * @Omer Mustafa (F2016-472)
 * @Abdullah Waqar (F2016-064)
 * @Mubashar Hussain (F2016-404)
*/
...
main()
{
    //This function runs the traversing
    run();
    return 0;
}
...
//Sync helps synchronizing the stream buffer, Otherwise we can't move forward the folder
            cin.sync();
            getline(cin,name);
            prev=cur;
            cur=cur->open(name);
